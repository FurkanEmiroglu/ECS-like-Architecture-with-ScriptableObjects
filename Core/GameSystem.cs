...
namespace ECSArchitecture.Core
{
    public abstract class GameSystem : ScriptableObject
    {
        ...
        {
            int id = component.EntityID < 0 ? AssignID(component) : component.EntityID;
        ...
        /// </summary>
        /// <param name="component"></param>
        public virtual void RemoveComponent(SystemComponent component)
        {
        ...
        /// </summary>
        /// <param name="component"></param>
        private int AssignID(SystemComponent component)
        {
